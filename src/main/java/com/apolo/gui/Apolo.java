...
public class Apolo extends JFrame {
    ...
    private JPanel playlistPanel = listenerController.getPlaylistPanel();
    private PlaylistManager playlistManager = listenerController.getPlaylistManager();
    private JList mainList = playlistManager.getMainList();
    private CardLayout cardLayout = playlistManager.getCardLayout();
    ...
    public Apolo(){
        ...
        /*DropTarget addMusicDropTarget = new DropTarget(playlistPanel, new DropTargetAdapter() {
            listenerController.addMusicByDropTarget();
        });
        ...
        mainList.addListSelectionListener(e -> {
            String selectedPlaylist = (String) mainList.getSelectedValue();
